...
// COMP (1) Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// COMP (2) Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// COMP (3) Give your TextView an ID of tv_display
// COMP (4) Set the text to something that indicates this is default text being displayed
// COMP (5) Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// COMP (6) Create a TextView field to display your message
// COMP (7) Get a reference to your TextView in Java