...
public class MainActivity extends AppCompatActivity {
    ...
    // COMP (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMP (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set
        // that text on our TextView
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                String lifeCycleCallbackString = savedInstanceState.getString
                        (LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(lifeCycleCallbackString);
            }
        }
        ...
        public void onSaveInstanceState(Bundle outState){
            ...
            // COMP (5) Put the text from the TextView in the outState bundle
            String mLifeCycleText = mLifecycleDisplay.getText().toString();
            outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, mLifeCycleText);
        }
