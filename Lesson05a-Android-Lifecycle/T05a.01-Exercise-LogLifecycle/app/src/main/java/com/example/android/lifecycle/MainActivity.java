...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMP (1) Use logAndAppend within onCreate
        logAndAppend(ON_CREATE);
    }

    // COMP (2) Override onStart, call super.onStart, and call logAndAppend with ON_START
    @Override
    ...
    // COMP (3) Override onResume, call super.onResume, and call logAndAppend with ON_RESUME
    @Override
    ...
    // COMP (4) Override onPause, call super.onPause, and call logAndAppend with ON_PAUSE
    ...
    // COMP (5) Override onStop, call super.onStop, and call logAndAppend with ON_STOP
    ...
    // COMP (6) Override onRestart, call super.onRestart, and call logAndAppend with ON_RESTART
    @Override
    ...
    // COMP (7) Override onDestroy, call super.onDestroy, and call logAndAppend with ON_DESTROY
    @Override
