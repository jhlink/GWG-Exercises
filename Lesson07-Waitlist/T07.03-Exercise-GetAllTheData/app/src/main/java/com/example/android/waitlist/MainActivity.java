...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMP (12) Pass the resulting cursor count to the adapter
    ...
    // COMP (5) Create a private method called getAllGuests that returns a cursor
    private Cursor getAllGuests() {
        // COMP (6) Inside, call query on mDb passing in the table name and projection String []
