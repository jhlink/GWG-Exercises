...
public class ReminderTasks {
    ...
    public static final String ACTION_INCREMENT_CHARGE_REMINDER_COUNT =
            "increment-charge-reminder-count";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_INCREMENT_CHARGE_REMINDER_COUNT.equals(action)) {
    ...
    // COMP (2) Create an additional task for issuing a charging reminder notification.
