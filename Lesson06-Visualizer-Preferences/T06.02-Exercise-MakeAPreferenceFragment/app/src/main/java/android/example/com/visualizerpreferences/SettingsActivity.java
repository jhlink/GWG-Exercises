...
public class SettingsActivity extends AppCompatActivity {
    ...
    // COMP (2) Create a class called SettingsFragment that extends PreferenceFragmentCompat
    // COMP (3) In res->xml create a file called pref_visualizer
    // COMP (4) In pref_visualizer create a preference screen containing a single check box preference
